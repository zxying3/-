    ...
    >
      ...
      <el-table-column label="操作" align="center" width="230px">
        <template slot-scope="scope">
          ...
          <el-button v-if="scope.row.approve_status!==1" size="mini" @click="handlePass(scope.$index, scope.row)">通过</el-button>
          <el-button v-if="scope.row.approve_status==1" size="mini" @click="save(scope.row)">保存</el-button>
          <el-button v-if="scope.row.approve_status!==2" size="mini" type="danger" @click="handleFail(scope.$index, scope.row)">拒绝</el-button>
        </template>
      </el-table-column>
    </el-table>
    <!-- table-footer -->
    <Page :total="total" show-total show-elevator @on-change="changePage" style="padding-top:10px;"></Page>
